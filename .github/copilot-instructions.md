...
* `docs/API.md` is generated from `docs/MACHINE_READABLE_API.json` and must not be edited by hand.
...
* When changing public APIs, update `docs/MACHINE_READABLE_API.json`, keep it valid against `docs/MACHINE_READABLE_API.schema.json`, and regenerate `docs/API.md` with `python tools/generate_api_md.py`.
